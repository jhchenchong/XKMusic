...
@interface XKCollectionComponent ()

@property (nonatomic, strong) UICollectionView *collectionView;

@end

@implementation XKCollectionComponent
...
- (void)reloadDataWithTableView:(UITableView *)tableView forSection:(NSInteger)section {
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    if ([self.delegate respondsToSelector:@selector(tableComponent:didTapItemAtIndex:)]) {
        [self.delegate tableComponent:self didTapItemAtIndex:indexPath.item];
    }
}
