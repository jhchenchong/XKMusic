...
- (void)applyConfigurationTemplate {
    ...
    QMUICMI.buttonTintColor = UIColorBlack;                                      // ButtonTintColor : QMUIButton 默认的 tintColor，不影响系统的 UIButton
    ...
    QMUICMI.navBarBackgroundImage = UIImageMake(@"cm4_topbar_bg");                                        // NavBarBackgroundImage : UINavigationBar 的背景图
    QMUICMI.navBarShadowImage = [[UIImage alloc] init];                                            // NavBarShadowImage : UINavigationBar.shadowImage，也即导航栏底部那条分隔线
    ...
    QMUICMI.navBarBackIndicatorImage = [UIImage qmui_imageWithShape:QMUIImageShapeNavBack size:CGSizeMake(13, 21) tintColor:NavBarTintColor];;                                     // NavBarBackIndicatorImage : 导航栏的返回按钮的图片，图片尺寸需要为(13, 21)，如果尺寸不一致则会自动调整，以保证与系统的返回按钮图片布局相同。
    ...
    QMUICMI.tabBarBackgroundImage = UIImageMake(@"cm2_btm_bg");                                        // TabBarBackgroundImage : UITabBar 的背景图
    ...
    QMUICMI.tabBarItemTitleColor = TabBarTintColor;                                         // TabBarItemTitleColor : 未选中的 UITabBarItem 的标题颜色
    QMUICMI.tabBarItemTitleColorSelected = UIColorWhite;                     // TabBarItemTitleColorSelected : 选中的 UITabBarItem 的标题颜色
